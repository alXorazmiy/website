            ...
            <div class="w-[400px] h-[450px] bg-[#151b23] rounded ">
                <form @submit.prevent = "register" class="h-full w-full p-3 flex justify-around flex-col items-center relative ">
                    ...
                    <div class = "w-[80%] mx-auto" >
                        ...
                        <button type="submit" class="bg-[#238636] w-full h-10 p-2 rounded flex items-center justify-center my-8 ">
                    ...
                    <div class = "absolute bottom-2" >
                        <span class="text-gray-400">You have account?</span>
                        <NuxtLink to="/login" class="ml-3 text-blue-400 cursor-pointer">Login</NuxtLink>
                    </div>
